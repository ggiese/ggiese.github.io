...
to go
  ...
  ask turtles [
    ...
    ;; exert the wind force
    ifelse wind
    [ set xvel xvel + wind-speed * 0.01 ]
    [ set xvel xvel ]
    ;; detect crashes and insufficiently soft landings
    if [pcolor] of patch-at 0 -2 != black [
      ifelse (abs yvel > 0.08) or
             (abs xvel > 0.04 and not wind) or (abs xvel > 0.4 and wind) or
             (heading != 0 and not wind) or (abs heading > 10 and wind) or           ((pxcor - platform) >= platform-width / 2)
      [ game-over ]
      [ set color green - 1 ]
    ]
...
Rectangle -16777216 true false 60 120 90 150
Rectangle -16777216 true false 135 120 165 150
Rectangle -16777216 true false 210 120 240 150
Rectangle -16777216 true false 135 60 165 90
...
Rectangle -16777216 true false 60 135 90 165
Rectangle -16777216 true false 135 135 165 165
Rectangle -16777216 true false 210 135 240 165
Rectangle -16777216 true false 135 75 165 105
